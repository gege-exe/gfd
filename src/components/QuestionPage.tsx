...
const QuestionPage = ({ onYes }: QuestionPageProps) => {
  ...
  return (
    <div className="min-h-screen gradient-soft flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="text-center z-10 max-w-2xl mx-auto px-6">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-6xl font-bold mb-4 gradient-romantic bg-clip-text text-transparent">
